"""
Pydantic v2 schemas and data definitions for Grade Evidence Certainty Agent.
...
class SystemTaskPayload(BaseModel):
    ...
    @classmethod
    def validate_metric_is_finite(cls, v: float) -> float:
        """Reject NaN and infinite values which would corrupt threshold comparisons."""
...
class ConsensusDossier(BaseModel):
    dossier_id: str
    system_slug: str = "grade-evidence-certainty-agent"
