"""
Clinical Data Models & Enums for GRADE-Master: Autonomous Body of Evidence Certainty & Recommendation Scorer.
...
class AgentAlert:
    ...
    guideline_citation: str = "GRADE Handbook for Evidence Synthesis"
    timestamp: str = field(default_factory=lambda: datetime.datetime.now(datetime.timezone.utc).isoformat())
